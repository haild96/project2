      ...
      $.ajax({
       ...
       $('.dathang').click(function() {
    	...
    	// 	alert('Địa chỉ email không hợp lệ');
	        ...
	        $(".footer").css({"z-index":"1"});
    		$.ajax({
    			url: '/project2/Home/addBill',
    			type: 'POST',
    			data: {sex:sex,name:name,phone:phone,email:email,address:address,note:note}
    		})
    		.done(function() {
    		})
    		.fail(function() {
    		...
    		.always(function() {
    		alert('Đơn hàng đã đặt thành công.Tiếp tục mua sắm');
